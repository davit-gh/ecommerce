...
################################
# OVERRIDEN CARTRIDGE SETTINGS #
################################

# Disable product ratings.
SHOP_USE_RATINGS = False

# Maximum number of products before pagination occurs
SHOP_PER_PAGE_CATEGORY = 12

# Disable "wishlist" functionality for now
...
EXTRA_MODEL_FIELDS = (
    (
        "mezzanine.galleries.models.GalleryImage.link",
        "CharField",
        (_("Point to URL"),),
        {"max_length": 100, "blank": True, "null": True},
    ),
    (
        "cartridge.shop.models.Product.image_back",
        "mezzanine.core.fields.FileField",
        (_("Additional Image"),),
        {"blank": True, "null": True, "upload_to": "additional_images"},
    ),
    (
        "mezzanine.blog.models.BlogPost.lead",
        "TextField",
        (_("Lead Paragraph"),),
        {"blank": True, "null": True, "help_text": "Can remain blank."},
    ),
)
...
# Used in a mixin in "main" app's models.py to define the number of
# days for which the product is considered new. is_new(self) method is
# used to determine whether the "NEW" label should be applied to the
# product image.
IS_NEW_DAYS = 7

# Used for limiting the number of "Recently viewed" products displayed on
# product page and when "Recently viewed" is clicked on top right of a page.
RECENT_MAXLEN = 6
